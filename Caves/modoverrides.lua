return {
  ...
  ["workshop-2166704267"]={
    configuration_options={ ENABLEBACKPACK=false, INVENTORYSIZE=45, MOREEQUIPSLOTS=0 },
    enabled=true 
  },
  ["workshop-2322021415"]={ configuration_options={ inventory=1, perishtime=0.5 }, enabled=true },
  ["workshop-2746815492"]={
    configuration_options={
      KRAMPUSSACKLOOTCHANCE=100,
      KRAMPUSSACKLOOTslurtle=100,
      KRAMPUSSACKLOOTwalrus01=100,
      KRAMPUSSACKLOOTwalrus02=100,
      beeloop=90,
      butterflyloop=50 
    },
    enabled=true 
